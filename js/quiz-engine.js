/* ============================================
   ...
   (ported from AI Mastery Academy quiz-engine.js)
   ============================================ */
                    ...
                    ${this.questions.map((_, i) => `
                        <div onclick="QuizEngine.goToQuestion(${i})"
                             ...
                             ${i === this.currentQuestion ? 'background:var(--ai-purple);color:#fff;' :
                               ...
                               'background:var(--bg-hover);color:var(--text-secondary);'}">${i + 1}</div>
                    `).join('')}
                </div>
            </div>`;
    },
    ...
    showResults() {
        ...
        container.innerHTML = `
            <div class="quiz-results fade-in">
                ...
                <p style="color:var(--text-secondary);margin:12px 0">${passed ? 'Great job! You\'ve demonstrated solid understanding of this build.' : 'You need 70% to pass. Review the material and try again.'}</p>
                ...
                <div style="margin-top:32px;text-align:left">
                    ...
                    ${this.questions.map((q, i) => `
                        <div style="padding:12px;margin-bottom:8px;border-radius:8px;background:${this.answers[i] === q.correct ? 'rgba(52,211,153,.12)' : 'rgba(248,113,113,.12)'}">
